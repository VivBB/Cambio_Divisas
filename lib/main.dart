                      ...
                      child: Card(
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            ...
                            if (index < 10) {
                              text_origen.text =
                                  text_origen.text + info[index].titulo;
                            } else if (index == 10) {
                              text_origen.text = "";
                              text_destino.text = "";
                            } else {
                              if (op1 == "USD" && op2 == "COP") {
                                text_destino.text =
                                    (double.parse(text_origen.text) * 4974)
                                        .toString();
                                ...
                                text_destino.text =
                                    (double.parse(text_origen.text) * 5075)
                                        .toString();
                                ...
                                text_destino.text =
                                    (double.parse(text_origen.text) * 0.99)
                                        .toString();
